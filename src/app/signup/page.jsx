        ...
        <div className="space-y-8 animate-fade-in-left">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4 animate-slide-up" style={{animationDelay: '0.2s'}}>
              ...
              <div>
                <h3 className="font-semibold text-gray-800">Smart Career Matching</h3>
                <p className="text-gray-600">AI algorithms find opportunities that match your skills and goals</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 animate-slide-up" style={{animationDelay: '0.4s'}}>
              ...
              <div>
                ...
                <p className="text-gray-600">Access curated learning paths to enhance your expertise</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 animate-slide-up" style={{animationDelay: '0.6s'}}>
              ...
              <div>
                ...
                <p className="text-gray-600">Track your progress and achieve your professional milestones</p>
              </div>
            </div>
          </div>
          
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-xl border border-purple-100 animate-slide-up" style={{animationDelay: '0.8s'}}>
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h4 className="font-semibold text-gray-800">Free to Join, Always</h4>
            </div>
        ...
        <div className="animate-fade-in-right">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/20">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Join CareerOstad and unlock your potential</p>
            </div>
            <SignupForm />
          </div>
        </div>
