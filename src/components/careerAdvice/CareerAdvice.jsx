const features = [
  {
    ...
    description:
      "Explore career tracks based on your education, interests, and local job demand.",
    button: "Explore My Path",
  },
  {
    title: "📊 Skill Gap & Salary Benchmarking",
    description:
      "Identify missing skills and compare salary benchmarks across industries.",
    button: "Check My Skills",
  },
  {
    title: "🎤 AI Interview Coach (Bangla + English)",
    description:
      "Practice interviews with bilingual AI feedback and downloadable reports.",
    button: "Practice Interview",
  },
  {
    title: "📄 CV & LinkedIn Analyzer",
    description:
      "Get achievement-based suggestions and bilingual CV formatting tips.",
    button: "Optimize Profile",
  },
  {
    title: "📈 Career Progress Tracker",
    description:
      "Track your growth, readiness score, and share certificates on LinkedIn.",
    button: "Track My Growth",
  },
  {
    title: "🗣️ Local HR Insights & Expert Tips",
    description:
      "Weekly tips from HR leaders and AI-curated job market updates.",
    button: "Get Insights",
  },
];
    ...
    <section className="container mx-auto">
      ...
      <div className="card my-6 bg-white shadow-xl">
        <div className="card-body">
          ...
          <p>
            Upload your resume and get AI-powered suggestions to improve
            keywords, formatting, and achievements.
          </p>
          <div className="card-actions justify-end">
