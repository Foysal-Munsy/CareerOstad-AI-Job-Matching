    ...
    return (
        <>
            ...
            <ul className='border-b pb-4 -mx-4 flex flex-col gap-2 menu-list text-lg justify-center'>
                ...
                <details className="collapse collapse-plus">
                    ...
                    <div className="collapse-content text-sm">
                        <ul onClick={() => setSideMenu(!sideMenu)}>
                            <li className='sub-menu-list px-5 py-2.5'><a href="#">Candidate Dashboard<span className='hidden go-icon'>&gt;</span></a></li>
                            <li className='sub-menu-list px-5 py-2.5'><a href="#">Match Your Skill<span className='hidden go-icon'>&gt;</span></a></li>
                            <li className='sub-menu-list px-5 py-2.5'><a href="#">Apply For Job<span className='hidden go-icon'>&gt;</span></a></li>
                        </ul>
                    </div>
                </details>
                <details className="collapse collapse-plus">
                    ...
                    <div className="collapse-content text-sm">
                        <ul>
                            <li className='sub-menu-list px-5 py-2.5'><a href="#">Company Dashboard<span className='hidden go-icon'>&gt;</span></a></li>
                            <li className='sub-menu-list px-5 py-2.5'><a href="#">Match Candidate<span className='hidden go-icon'>&gt;</span></a></li>
                ...
                <Link href='/' className='inline-flex text-sm items-center bg-primary text-white cursor-pointer px-4 py-1 rounded-lg transition-all duration-1000 w-fit justify-center'>
                    Signup
                </Link>
                </div>
            </ul>
